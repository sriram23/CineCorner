...
const Credit = ({data}) => {
    ...
    return (
        <div className='flex flex-col items-center m-4 p-4 w-52 border-black dark:border-white border-2 rounded-md ' style={{maxWidth: '50rem', width: '100%', background:'rgba(25,25,25,0.4)'}}>
